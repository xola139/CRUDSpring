package com.kardumen.customer.dao.impl;
...
import com.kardumen.customer.model.CustomerRowMapper;
...
public class JdbcCustomerDAO extends JdbcDaoSupport implements CustomerDAO
{
	...
	public void insert(Customer c){
		String sql = "INSERT INTO USUARIOS (USR_ID,USR_NOMBRE,USR_PASSWORD,USR_NOMBRECOMPLETO,USR_NIVEL)" +" VALUES (?, ?, ?, ? , ? )";
	...
	public List<Customer> findAll(){
			...
			for (Map row : rows) {
				...
				customer.setUsr_id((Long.valueOf(row.get("usr_id").toString())));
				customer.setUsr_nombre(row.get("usr_nombre").toString());
